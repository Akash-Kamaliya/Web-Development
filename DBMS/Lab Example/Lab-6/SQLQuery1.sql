...
SELECT *
FROM STUDENT
WHERE (LASTNAME LIKE 'SHAH') AND ((WEBSITE LIKE '%COM%') OR (WEBSITE IS NULL ))AND (CITY LIKE '%D')
...
SELECT *
FROM STUDENT
WHERE (FIRSTNAME LIKE '[A,E,I,O,U][A,E,I,O,U]%') AND ((WEBSITE LIKE '%.COM%'))AND (CITY LIKE 'R%')
--------------------------------------------------------------------------------------------
-- Part – B:
...
SELECT *
FROM STUDENT
WHERE (FIRSTNAME NOT LIKE 'A%') AND (WEBSITE LIKE '%.COM')AND (CITY LIKE '[R,B]%') AND (ADDRESS1 LIKE '%-%')
------------------------------------------------------------------------------------------------
-- Part – C:
...
SELECT *
FROM STUDENT
WHERE  (ADDRESS1 LIKE '%[''"]%') AND (CITY NOT LIKE '%S%') AND (LASTNAME LIKE 'P%') AND (WEBSITE LIKE '%ON%');
---------------------------------------------------------------------------------------------------------