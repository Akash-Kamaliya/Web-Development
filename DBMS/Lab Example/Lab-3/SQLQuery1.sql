...
FROM CUSTOMERS;
-- 3.
-- Retrieve records from the BORROW table where the loan amount is greater than 3000 and the loan number is not a multiple of 3.
SELECT *
FROM BORROW
WHERE (AMOUNT >3000) AND (LOANNO % 3 != 0);
-- 4.
-- Retrieve records from the DEPOSIT table where amount is greater than 2000 also account number is between 100 and 110 and date is after '1-MAR-1995' or before '27-MAR-1996'.
SELECT *
FROM DEPOSITE_DEMO123
